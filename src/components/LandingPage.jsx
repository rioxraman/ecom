...
import Loader from './loc/Loader'

import RecipeReviewCard from "./RecipeReviewCard";
import "../styles/main.css";
import axios from "axios";
import PaginationRounded from "./loc/Pagination";
import ClearIcon from "@mui/icons-material/Clear";
import { toast } from "react-toastify";

const LandingPage = ({ handleClick, handlePdp }) => {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        toast.warning(`Fetching product list`)
        setLoading(true);
